    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('admin.employees.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-md text-xs hover:bg-gray-600">
                    &#x2190; Voltar para a Lista
                </a>
            </div>
        </div>
                    ...
                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        ...
                        <div class="p-3 bg-gray-50 rounded-lg">
                            ...
                            <dd class="mt-1 text-lg">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $employee->status === 'ativo' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                        ...
                        <div class="p-3 bg-gray-50 rounded-lg md:col-span-2"> <dt class="text-sm font-medium text-gray-500">Endereço Completo</dt>
                        ...
                        <div class="p-3 bg-gray-50 rounded-lg">
                            ...
                            <dd class="mt-1 text-lg text-gray-900">{{ $employee->types['nome'] }}</dd>
                        </div>

                        <div class="p-3 bg-gray-50 rounded-lg">
                            <dt class="text-sm font-medium text-gray-500">Data de Admissão</dt>
                            <dd class="mt-1 text-lg text-gray-900">{{ \Carbon\Carbon::parse($employee->data_admissao)->format('d/m/Y') }}</dd>
                        </div>

                        <div class="p-3 bg-gray-50 rounded-lg">
                            <dt class="text-sm font-medium text-gray-500">Data de Nascimento</dt>
                            <dd class="mt-1 text-lg text-gray-900">{{ \Carbon\Carbon::parse($employee->data_nascimento)->format('d/m/Y') }}</dd>
                        </div>
                         ...
                         <div class="p-3 bg-gray-50 rounded-lg">
                            ...
                            <dd class="mt-1 text-lg text-gray-900">{{ \Carbon\Carbon::parse($employee->created_at)->format('d/m/Y \à\s H:i:s') }}</dd>
                        </div>
                    </dl>
