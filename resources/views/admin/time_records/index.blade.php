<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Bucar Registros de Ponto') }}
        </h2>
    </x-slot>

    <div class="py-12">
        @if (isset($error['mensagem']))
            <div class="mb-4 font-medium text-lg text-red-600 flex items-center justify-center">
                {{ $error['mensagem'] }}
            </div>
        @endif
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Buscar Registros</h3>
                <form method="GET" action="{{ route('admin.time-records.index') }}">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="flex items-end space-x-2">
                            <a href="{{ route('admin.time-records.index') }}"
                            ...
                            <button type="submit"
                                class="bg-gray-800 w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                                Buscar
                            </button>
                        </div>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3"
                                        class="px-6 py-4 whitespace-nowrap text text-red-600 text-gray-500 text-center">
